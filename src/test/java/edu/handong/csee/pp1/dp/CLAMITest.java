...
public class CLAMITest {
	...
	@Test
	public void testCLAMIWithYourSelectedProject_1() {
		
		// TASK3: Conduct defect prediction by using CLAMI models
		// complete this test case for the generated arff files from Task 2
		
		String[] args = {"-f","data/Criminals.arff","-l","label","-p", "buggy", "-m"};
		
		CLAMI.main(args);
	}
	
	@Test
	public void testCLAMIWithYourSelectedProject_2() {
		
		// TASK3: Conduct defect prediction by using CLAMI models
		// complete this test case for the generated arff files from Task 2
		
		String[] args = {"-f","data/hw0.arff","-l","label","-p", "buggy", "-m"};
