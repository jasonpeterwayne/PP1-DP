...
public class MainTest {
	...
	public void testMain() {
		...
		String[] args = {"/Users/kwak-yeonghye/git/test/PP1-DP", "data/PP1-DP.arff"}; // for mac users
	...
	public void testForTasks2_1() { 
		...
		String[] args = {"/Users/kwak-yeonghye/git/test/Criminaldbms/Criminals", "data/Criminals.arff"}; // for mac users
	...
	public void testForTasks2_2() {
		...
		// 생성이 된 후 commit/push해야 함.
		// 위 test main을 참고하여 실행하면 됨.
		String[] args = {"/Users/kwak-yeonghye/git/test/hw0", "data/hw0.arff"}; // for mac users
